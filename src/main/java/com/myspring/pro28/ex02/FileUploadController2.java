...
public class FileUploadController2 {
	private static final Logger logger = LoggerFactory.getLogger(FileUploadController2.class);
	private static final String CURR_IMAGE_REPO_PATH = "c:\\spring\\image_repo\\thumbnail";
