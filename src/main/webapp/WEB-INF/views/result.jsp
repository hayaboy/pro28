...
--%>
	...
	<c:if test="${not empty map.fileList}">
		<c:forEach var="imageFileName" items="${map.fileList}">
			<img
				src="${pageContext.request.contextPath}/download1?imageFileName=${imageFileName}" />
			<a
				href="${pageContext.request.contextPath}/download1?imageFileName=${imageFileName}">내려받기
			</a>
			<br>
